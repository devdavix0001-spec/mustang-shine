...
export function CtaBand({
  ...
  title = "READY FOR A BETTER-PERFORMING SPACE?",
  body = "Tell us what you're working on. We'll evaluate the space, recommend the right insulation system, and provide a clear quote.",
}: {
  variant?: "red" | "dark";
  eyebrow?: string;
  title?: string;
