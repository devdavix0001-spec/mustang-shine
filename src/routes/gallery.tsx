...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: `https://mustanginsulation.com/gallery` }],
  }),
...
const projects: Project[] = [
  ...
  // Commercial
  {
    ...
    problem:
      "A large-scale distribution facility requiring insulation across significant square footage.",
    solution:
      "A coordinated commercial insulation scope scheduled around active warehouse operations.",
    result:
      "A completed large-format commercial insulation install with minimal disruption to operations.",
  },
  {
  ...
  },
  {
    ...
    solution:
      "Insulation installed to the project specification as part of the build-out schedule.",
  ...
  },
  {
    ...
    problem:
      "A commercial project specifying closed-cell foam for its air-sealing and R-value performance.",
  ...
  },
  {
    ...
    problem:
      "A commercial project requiring insulation installed and verified against the approved scope.",
  ...
  },
  {
    ...
    problem:
      "A commercial ceiling assembly needing a pin-weld insulation system for consistent coverage.",
  ...
  },
  {
    ...
    problem:
      "A commercial building specifying a pin-weld insulation system for walls and ceilings.",
  ...
  },
  {
    ...
    problem:
      "An automotive shop needing insulation for comfort and noise control in a working shop environment.",
