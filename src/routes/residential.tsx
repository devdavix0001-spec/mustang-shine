...
export const Route = createFileRoute("/residential")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: `https://mustanginsulation.com/residential` }],
  }),
...
const benefits = [
  ...
  },
  {
    icon: Wind,
    title: "Cleaner Air",
    body: "Air sealing attic penetrations can help reduce unwanted attic air, dust, and airborne contaminants entering the conditioned space.",
  },
];
...
const projects: Project[] = [
  {
    src: residential1,
    alt: "Residential attic insulation project in a DFW home",
    category: "homes",
  },
  {
    src: residential2,
  ...
  {
    src: openCell1,
    alt: "New construction open-cell spray foam insulation install",
    category: "open-cell",
  },
  {
    src: openCell2,
  ...
  {
    src: nmf1,
    alt: "17-unit condo build insulation project in Arlington, TX",
