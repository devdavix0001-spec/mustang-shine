...
import project26 from "@/assets/mbw-1.jpg";
...
const serviceImages: Record<string, string> = {
  ...
  "attic-air-sealing": project14,
  "radiant-barriers": project17,
      ...
      links: [
        {
          rel: "canonical",
          href: service
            ? `https://mustanginsulation.com/services/${service.slug}`
            : "https://mustanginsulation.com/services",
        },
      ],
    };
  },
