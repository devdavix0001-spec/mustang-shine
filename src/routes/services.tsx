...
export const Route = createFileRoute("/services")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: `https://mustanginsulation.com/services` }],
  }),
