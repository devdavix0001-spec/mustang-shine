...
import aboutImage from "@/assets/Spray Foam Insulation-3.jpg";
...
export const Route = createFileRoute("/about")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: `https://mustanginsulation.com/about` }],
  }),
  component: AboutPage,
});

const values = [
  "Clear communication from the first walkthrough to the final cleanup.",
