...
export const Route = createFileRoute("/commercial")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: `https://mustanginsulation.com/commercial` }],
  }),
...
const projectGroups: ProjectGroup[] = [
  ...
  {
    id: "closed-cell-foam-commercial",
    name: "Closed-Cell Foam Commercial",
...
function CommercialPage() {
  const list = services.filter((s) => s.track !== "residential" && s.slug !== "rodent-exclusion");
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-2 lg:items-start">
          <Reveal>
            ...
            <p className="mt-5 text-base leading-relaxed text-white/70">
              We’ll review the scope and provide a clear written proposal outlining materials,
              R-values, schedule considerations, and applicable requirements.
            </p>
